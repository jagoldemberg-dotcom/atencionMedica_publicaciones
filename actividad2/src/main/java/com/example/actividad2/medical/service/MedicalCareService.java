...
public class MedicalCareService {
    ...
    void seed(){
        patients.addAll(List.of(
                ...
                new Patient(3L, "7.444.321-K", "Carlos", "Muñoz", LocalDate.of(2001, 7, 21), "+56 9 3333 3333", "carlos.munoz@example.com"),
                new Patient(3L, "7.233.321-K", "Alejandra", "Muñoz", LocalDate.of(2001, 7, 21), "+56 9 3333 3333", "alejandra.munoz@example.com")
        ));
        visits.addAll(List.of(
                ...
                new MedicalVisit(4L, 2L, LocalDate.now().minusDays(15), "Oftalmología", "Miopía", "Indicación de lentes"),
                new MedicalVisit(4L, 1L, LocalDate.now().minusDays(15), "Dermatología", "Tinia", "Clotrimazol"),
                new MedicalVisit(4L, 3L, LocalDate.now().minusDays(15), "Kinesiología", "Deformacion", "Terapia")
        ));
    }
